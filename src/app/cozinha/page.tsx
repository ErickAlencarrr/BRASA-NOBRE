...
export default function KitchenPage() {
  ...
  async function handleStatusChange(id: number, currentStatus: string) {
    ...
    else if (currentStatus === 'PRONTO') nextStatus = 'ENTREGUE'; // Remove from kitchen view
  ...
  if (loading) return <div className="p-8 font-bold text-white text-center">Carregando Cozinha...</div>;
