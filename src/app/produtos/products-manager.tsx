...
export default function ProductsManager({ role }: { role?: string }) {
  ...
  function abrirModal(produto?: Product) {
    if (role !== 'ADMIN') return; // Bloqueia edição para não-admin
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div>
          ...
          <div className="flex gap-2">
            ...
            <Link
              href="/cozinha"
              className="inline-flex items-center gap-2 bg-slate-800 dark:bg-slate-700 px-4 py-2 rounded-lg text-white font-bold hover:bg-slate-700 dark:hover:bg-slate-600 transition shadow">
                🍳 Cozinha
            </Link>
          </div>
        </div>
